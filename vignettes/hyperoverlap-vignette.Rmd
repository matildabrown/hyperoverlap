...
```
To examine the result:
```{r, results='show',  fig.height=4,fig.width=4, fig.align="center"}
...
transformed_data <- hyperoverlap_lda(setosa_virginica4d, visualise3d=TRUE)  #plots the best three dimensions for visualising overlap
```
